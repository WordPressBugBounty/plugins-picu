...
* **Added:** Compatibility with picu Pro 2.5.0.

* **Updated:** picu Pro 2.5.0 or higher is required for using picu 3.5.0.
...
* **Added:** picu Pro Black Friday notice

### 3.3.0
Release Date: 2025-10-31

* **Added:** Compatibility with picu Pro 2.3.0.
...
* **Added:** Compatibility with picu Pro 2.2.0.
...
* **Fixed:** We fixed a bug where picu could send reminder emails even if the collection had already been approved.
