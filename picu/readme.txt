...
* Enhancements
  ...
  * Changing the order of collection images can now be undone
  * Display a notice, if the old Pro modules are still in use
...
* Bugfixes
	...
	* Fixed a bug where email content was not formatted correctly
